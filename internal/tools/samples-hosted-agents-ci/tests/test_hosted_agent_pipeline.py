...
CI = ROOT / "internal" / "tools" / "samples-hosted-agents-ci"
...
class PipelineTests(unittest.TestCase):
    ...
    def test_step_contract(self):
        ...
        self.assertRegex("internal/tools/samples-hosted-agents-ci/run-hosted-agent.sh", shared_pattern)
        self.assertRegex("internal/tools/samples-hosted-agents-ci/tests/test_hosted_agent_pipeline.py", shared_pattern)
